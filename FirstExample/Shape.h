...
struct Cube : public Shape
{
	Cube(int scale)
	{
		...
		shape_uvs = {
			// Front.
			0.0f * scale , 0.0f * scale, 	// 0.
			1.0f* scale, 0.0f* scale, 	// 1.
			1.0f* scale, 1.0f* scale, 	// 2.
			0.0f* scale, 1.0f* scale,		// 3.
			// Right.		 
			0.0f* scale, 0.0f* scale, 	// 1.
			1.0f* scale, 0.0f* scale, 	// 5.
			1.0f* scale, 1.0f* scale, 	// 6.
			0.0f* scale, 1.0f* scale,		// 2.
			// Back.		
			0.0f* scale, 0.0f* scale, 	// 5.
			1.0f* scale, 0.0f* scale, 	// 4.
			1.0f* scale, 1.0f* scale,		// 7.
			0.0f* scale, 1.0f* scale,		// 6.
			// Left.		
			0.0f* scale, 0.0f* scale,		// 4.
			1.0f* scale, 0.0f* scale,		// 0.
			1.0f* scale, 1.0f* scale,		// 3.
			0.0f* scale, 1.0f* scale,		// 7.
			// Top.			
			0.0f* scale, 0.0f* scale,		// 7.
			...
			0.0f* scale, 0.0f* scale,		// 4.
			1.0f* scale, 0.0f* scale,		// 5.
			1.0f* scale, 1.0f* scale,		// 1.
			0.0f* scale, 1.0f* scale		// 0.
		};
...
{
	Prism(int sides, int scaleX, int scaleY)
	{
		float theta = 0.0f;
		// Top face.
		...
		for (int i = 0; i < shape_vertices.size(); i += 3)
		{
			shape_uvs.push_back(shape_vertices[i] / sides * scaleX); // No texture for grid so value doesn't matter.
			shape_uvs.push_back(shape_vertices[i+1] / sides *scaleY);
		}
		ColorShape(1.0f, 1.0f, 1.0f);
		CalcAverageNormals(shape_indices, shape_indices.size(), shape_vertices, shape_vertices.size());
	}
...
{
	Cone(int sides, int scaleX, int scaleY)
	{
		float theta = 0.0f;
		// Bottom face.
		shape_vertices.push_back(0.5f);
